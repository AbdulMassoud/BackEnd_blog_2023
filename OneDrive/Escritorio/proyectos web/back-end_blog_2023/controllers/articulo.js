...
const prueba = (req, res) => {
    return res.status(200).json({
        messaje: "Soy una accion de prueba en mi controlador de articulos"
    });
}
...
const crear = (req, res) => {
    ...
    //Asignar valores a objeto basado en el modelo (manuel o automatico)
...
//Listar articulos por orden del mas reciente al mas antiguo
const listar = (req, res) => {
    ...
    consulta.sort({ fecha: -1 })// aqui se organizan, al poner el -1 se organizan de ultimo a primero
...
const subir = (req, res) => {
    ...
    //Recoger el ficherode imagen subido

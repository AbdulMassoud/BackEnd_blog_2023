...
const following = (req, res) => {
    ...
    // Comprobar si me llega la pagina, si no lo pagina 1
    let page = 1;

    if (req.params.page) page = req.params.page;
    
    // Usiarios por pagina quiero mostrar
    ...
    Follow.find({ user: userId })
          ...
          .paginate(page, itemsPerPage, async(error, follows, total) => {
            ...
            // Sacar un array de ids de los usuarios que me siguen y los que sigo como el usuario logeado
...
// Accion listado de usuarios que siguen a cualquier usuario otro usuario (soy seguido, mis seguidores)
